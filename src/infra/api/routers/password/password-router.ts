...
export class PasswordRouter implements PasswordRouterInterface {
  ...
  public async delete(passwordId: string): Promise<HttpResponse<Password>> {
    const apiLink = `${this.apiConnection.getLink()}/${
      this.route
    }/${passwordId}`;
    const authorization = this.tokenStorage.getAuthorization();
  ...
  public async getOne(passwordId: string): Promise<HttpResponse<Password>> {
    const apiLink = `${this.apiConnection.getLink()}/${
      this.route
    }/${passwordId}`;
    const authorization = this.tokenStorage.getAuthorization();
  ...
  public async getAll(): Promise<HttpResponse<Password[]>> {
    const apiLink = `${this.apiConnection.getLink()}/${this.route}`;
    const authorization = this.tokenStorage.getAuthorization();
